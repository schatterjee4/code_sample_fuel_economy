...
public interface VehicleEndpoint {
	...
	Call<MenuItemsResponse> getListOfModels(@Query("year") int year, @Query("make") String make);

	@GET("/ws/rest/vehicle/menu/options")
	Call<MenuItemsResponse> getListOfVehicleOptions(@Query("year") int year, @Query("make") String make, @Query("model") String model);
